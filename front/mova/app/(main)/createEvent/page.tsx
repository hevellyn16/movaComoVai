...
export default function CreateEventPage() {
  ...
  const handleSalvarRascunho = () => {
    const formElement = document.getElementById("form-evento") as HTMLFormElement;
    ...
    const rascunhoData = {
      ...
      localNome: formData.get("localNome"),
      ...
      ClassificacaoIndicativa: formData.get("classificacaoIndicativa"),
      infraestrutura: {
        acessibilidade: formData.get("acessibilidade") === "on",
        estacionamento: formData.get("estacionamento") === "on",
        alimentacao: formData.get("alimentacao") === "on",
        banheiros: formData.get("banheiros") === "on"
      },
      imagemCapa: null, // Placeholder para a imagem de capa
      status: "RASCUNHO" 
    };

    console.log("Salvando Rascunho...", rascunhoData);
  };

  const handlePublicarEvento = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    ...
    console.log("Publicando Evento...", eventoData);
    alert("Evento publicado com sucesso! (Verifique o console [F12])");
  };
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex justify-between items-end mb-8">
              ...
              <div className="flex gap-3">
                <button onClick={handleSalvarRascunho} type="button" className="cursor-pointer px-5 py-2.5 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
                  Salvar Rascunho
                </button>
                <button type="submit" form="form-evento" className="cursor-pointer flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-white bg-[#b91c1c] border border-transparent rounded-lg hover:bg-[#991b1b] transition-colors shadow-sm">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input required name="titulo" type="text" placeholder="ex: Festival de Quadrilhas de Sobral" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-[#b91c1c] focus:border-[#b91c1c] outline-none transition-colors" />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-1">Descrição *</label>
                      <textarea required rows={4} name="descricao" placeholder="Descreva o evento, atrações e importância cultural..." className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-[#b91c1c] focus:border-[#b91c1c] outline-none transition-colors resize-none"></textarea>
                    </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input required name="localNome" type="text" placeholder="ex: Margem Esquerda do Rio Acaraú" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-[#b91c1c] outline-none" />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-1">Endereço Completo *</label>
                      <input required name="enderecoCompleto" type="text" placeholder="Rua, Número, Bairro" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-[#b91c1c] outline-none" />
                    </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  ...
                  <div>
                    ...
                    <input name="capacidade" type="text" placeholder="ex: 500" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-[#b91c1c] outline-none" />
                  </div>
                </div>
