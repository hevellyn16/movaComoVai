		...
		<main className="flex-1 p-6 bg-[#F8F6F3] min-h-screen">
			<div className="mx-auto max-w-screen-2xl">
				<div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
					...
					<button
						type="button"
						className="cursor-pointer inline-flex items-center justify-center rounded-full bg-mova-red px-5 py-3 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-mova-red-dark"
					>
						Salvar Perfil
					</button>
				</div>
						...
						<section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
							<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
								<div>
									...
									<p className="text-sm text-gray-500">
										Atualize a exibição do seu perfil e suas informações públicas.
									</p>
								</div>
								<div className="flex items-center gap-4">
									<div className="relative h-20 w-20 overflow-hidden rounded-full border border-gray-200 bg-gray-100">
										...
										<div className="absolute bottom-0 right-0 rounded-full bg-mova-red p-1 text-white shadow-md cursor-pointer">
						...
						<div>
							...
							<section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
								...
								<div className="mt-6 space-y-4">
									...
									<div className="flex items-center justify-between rounded-3xl border border-gray-200 bg-gray-50 px-4 py-4">
										<div>
											...
											<p className="text-xs text-gray-500">
												Apenas seguidores podem ver seus itens e eventos.
											</p>
										</div>
										<button
											type="button"
									...
									<div className="flex items-center justify-between rounded-3xl border border-gray-200 bg-gray-50 px-4 py-4">
										<div>
											<p className="text-sm font-semibold text-mova-dark">
												Status de Atividade
											</p>
											<p className="text-xs text-gray-500">
						...
						<section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
							<div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
								...
								<div className="flex flex-col gap-2 sm:flex-row">
									...
									<button
										type="button"
										className="cursor-pointer rounded-full bg-mova-red px-4 py-3 text-sm font-semibold text-white transition hover:bg-mova-red-dark"
									>
										Excluir Conta
									</button>
								</div>
          ...
          <div className="flex justify-end">
            <button
            type="button"
            className="cursor-pointer rounded-full bg-white px-8 py-4 text-base font-semibold text-mova-red transition hover:bg-mova-red-dark border hover:text-white">
            Sair
            </button>
          </div>
				</div>
