            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        {category && (
                            <span className="text-xs font-bold text-[#b91c1c] bg-red-50 px-2 py-0.5 rounded-full">
                                {category}
                            </span>
                        )}
                        <span
                    ...
                    {/* Nome */}
                    <h3 className="text-base font-bold text-gray-900 mt-1 truncate group-hover:text-[#b91c1c] transition-colors">
                        {event.eventName}
                    </h3>
